    ...
    override fun doFilterInternal(
        ...
        if (jwt != null) {
            jwtPlugin.validateToken(jwt)
                ...
                .onFailure { exception ->
                    when (exception) {
                        is ExpiredJwtException -> response.sendError(HttpStatus.UNAUTHORIZED.value(), "토큰이 만료되었습니다.")
                        else -> response.sendError(HttpStatus.UNAUTHORIZED.value(), "토큰이 유효하지 않습니다.")
                    }
                }
        }
